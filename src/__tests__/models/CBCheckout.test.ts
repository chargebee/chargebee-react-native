  ...
  test('should generate a proper url for a plan with options', () => {
    ...
    expect(url).toBe(
      'https://honeycomics-v3-test.chargebee.com/hosted_pages/plans/comics-box?addons[id][0]=extra-comic-book&' +
        ...
        'billing_address[country]=US&customer[cf_test]=testing&customer[email]=prabu@chargebeeinc.com&' +
        'customer[first_name]=Prabu&customer[last_name]=K&subscription[cf_sub_test]=subscription%2520value'
    );
  });
});
