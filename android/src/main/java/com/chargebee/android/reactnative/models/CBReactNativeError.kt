...
enum class CBReactNativeError(val code: Int) {
  ...
  companion object {
    fun fromBillingCode(code: Int) : CBReactNativeError {
      return when (code) {
        FEATURE_NOT_SUPPORTED, BILLING_UNAVAILABLE -> PURCHASE_NOT_ALLOWED
        // SERVICE_TIMEOUT was removed in Play Billing Library 8; timeouts now
        // surface as SERVICE_UNAVAILABLE. NETWORK_ERROR was added in PBL 6.
        ERROR, SERVICE_UNAVAILABLE, SERVICE_DISCONNECTED -> STORE_PROBLEM
        ...
        DEVELOPER_ERROR, ITEM_NOT_OWNED -> INVALID_PURCHASE
