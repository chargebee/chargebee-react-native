...
abstract class ChargebeeReactNativeSpec internal constructor(context: ReactApplicationContext) :
  ...
  abstract fun purchaseProduct(productId: String, offerToken: String, customer: ReadableMap, promise: Promise)
  ...
  abstract fun restorePurchases(includeInactivePurchases: Boolean, customer: ReadableMap, promise: Promise)
