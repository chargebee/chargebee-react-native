    ...
    <Modal animationType="slide" visible={show}>
      <View style={styles.centeredView}>
        <View style={styles.modalView}>
          ...
          <Text>Purchased Product: {purchasedOneTimeProduct.invoice_id}</Text>
          <Text>Charge ID: {purchasedOneTimeProduct.charge_id}</Text>
          <Text>User: {purchasedOneTimeProduct.customer_id}</Text>
          <Pressable
