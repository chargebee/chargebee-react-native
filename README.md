...
| addons | No | Addon[] | Parameters for addons. Multiple addons can be passed. Fields are listed below|
...
| billingAddress | No | Address | Billing address of the customer. Fields listed below |
| shippingAddress | No | String | Shipping address of the customer. Fields listed below |
